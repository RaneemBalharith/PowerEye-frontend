...
import ThirdTabView_totalWeekCO2 from '../co2/week/thirdTabView_totalWeekCO2';
import ThirdTabView_totalMonthCO2 from '../co2/month/thirdTabView_totalMonthCO2';
import ThirdTabView_totalYearCO2 from '../co2/year/thirdTabView_totalYearCO2';
const Week = () => (
   
    <View style={{ flex: 1 }} >
           <ThirdTabView_totalWeekCO2 />
...
export default function SecondTabView_totalCO2({ navigation }) {
