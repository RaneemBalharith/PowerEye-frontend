...
import TotalCost_LastYearPiechart from './totalCost_LastYearPiechart';
import TotalCost_ThisYearPiechart from './totalCost_ThisYearPiechart';
...
export default function ThirdTabView_totalYearCost({ navigation }) {
