...
import ThirdTabView_totalWeekEC from './week/thirdTabView_totalWeekEC';
import ThirdTabView_totalMonthEC from './month/thirdTabView_totalMonthEC';
import ThirdTabView_totalYearEC from './year/thirdTabView_totalYearEC';


const Week = () => (
   
    <View style={{ flex: 1 }} >
      <ThirdTabView_totalWeekEC /> 
...
export default function SecondTabView_totalEC({ navigation }) {
