...
import ApplianceCO2_ThisYearBarchart from './ApplianceCO2_ThisYearBarchart';
import ApplianceCO2_LastYearBarchart from './ApplianceCO2_LastYearBarchart';
...
export default function ThirdTabView_ApplianceYearCO2({ navigation }) {
