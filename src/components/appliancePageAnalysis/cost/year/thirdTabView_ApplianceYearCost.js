...
import ApplianceCost_ThisYearBarchart from './ApplianceCost_ThisYearBarchart';
import ApplianceCost_LastYearBarchart from './ApplianceCost_LastYearBarchart';
...
const LastYear = () => (
    <View style={{ flex: 1 }} >
        <ScrollView>
            <ApplianceCost_LastYearBarchart />
...
const ThisYear = () => (
    <View style={{ flex: 1 }} >
        <ScrollView>
        <ApplianceCost_ThisYearBarchart />
        <View style={{ marginTop: 30, marginBottom: 60, marginLeft: 100, marginRight: 100 }}>
...
export default function ThirdTabView_ApplianceYearCost({ navigation }) {
