...
import RoomCost_ThisYearBarchart from './RoomCost_ThisYearBarchart';
import RoomCost_LastYearBarchart from './RoomCost_LastYearBarchart';
...
export default function ThirdTabView_RoomYearCost({ navigation }) {
