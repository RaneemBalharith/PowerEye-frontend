...
import ThirdTabView_RoomWeekCO2 from '../co2/week/thirdTabView_RoomWeekCO2';
import ThirdTabView_RoomMonthCO2 from '../co2/month/thirdTabView_RoomMonthCO2';
import ThirdTabView_RoomYearCO2 from '../co2/year/thirdTabView_RoomYearCO2';

const Week = () => (
   
    <View style={{ flex: 1 }} >
           <ThirdTabView_RoomWeekCO2 />
...
export default function SecondTabView_RoomCO2({ navigation }) {
