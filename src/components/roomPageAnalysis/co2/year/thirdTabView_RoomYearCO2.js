...
import RoomCO2_ThisYearBarchart from './RoomCO2_ThisYearBarchart';
import RoomCO2_LastYearBarchart from './RoomCO2_LastYearBarchart';
...
export default function ThirdTabView_RoomYearCO2({ navigation }) {
