...
export const DeviceCard = ({
  ...
  const [wifiConnected, setWifiConected] = useState(true);
  const [deviceOnOff, setDeviceOnOff] = useState(deviceState);
  return (
    <ImageBackground
    ...
    >
      <View style={styles(theme).item}>
        <View style={styles(theme).cardToolsWrapper}>
          ...
          <View style={styles(theme).iconsWrapper}>
            <TouchableOpacity onPress={() => setWifiConected(!wifiConnected)}>
          ...
          <View style={styles(theme).iconsWrapper}>
            <TouchableOpacity onPress={() => setDeviceOnOff(!deviceOnOff)}>
              <MaterialCommunityIcons
                style={styles(theme).icons}
                name="power-standby"
                color={!deviceOnOff ? "#00707C" : "rgba(0,0,0,0.4)"}
                size={20}
              />
            </TouchableOpacity>
          </View>
